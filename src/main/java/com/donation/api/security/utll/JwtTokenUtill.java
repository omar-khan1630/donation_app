package com.donation.api.security.utll;
...
//
//import com.hms.api.response.JwtResponse;
//import com.hms.api.service.impl.UserDetailsImpl;
//
...
public class JwtTokenUtill {
	...
	@Value("${donation.api.jwtSecret}")
	private String jwtSecret;

	@Value("${donation.api.jwtExpirationMs}")
